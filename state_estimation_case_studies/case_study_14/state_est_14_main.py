...
from state_estimation_case_studies.case_study_14.state_est_14_parameters import *
...
if __name__ == '__main__':
    ...
    ylimits_cond = [0, 6]  # Plot boundary limits for y-axis
    ...
    ylimits_depo = [0, 6]  # Plot boundary limits for y-axis
    ...
    #######################################################
    # Temporary Loading:
    state_est_13_data = np.load('state_est_13_data.npz')
    n_logDp_plot_est_13 = state_est_13_data['n_logDp_plot']
    n_logDp_plot_upper_est_13 = state_est_13_data['n_logDp_plot_upper']
    n_logDp_plot_lower_est_13 = state_est_13_data['n_logDp_plot_lower']
    norm_diff_est_13 = state_est_13_data['norm_diff']
    ...
    for plot_time in times:
        # ax.plot(d_plot, n_logDp_plot_est_13[:, int(plot_time / dt)], '-', color='blue', linewidth=2, label='Mean Estimate')
        # ax.plot(d_plot, n_logDp_plot_upper_est_13[:, int(plot_time / dt)], '--', color='blue', linewidth=2, label='$\pm 2 \sigma$')
        # ax.plot(d_plot, n_logDp_plot_lower_est_13[:, int(plot_time / dt)], '--', color='blue', linewidth=2)
    ...
    ax.plot(t, norm_diff_est_13, '-', color='chocolate', linewidth=2, label='Without BAE')
    ...
    n_logDp_plot_est_13 = n_logDp_plot_est_13.clip(image_min, image_max)
    im = plt.pcolor(time, d_plot, n_logDp_plot_est_13, cmap=cmap, vmin=image_min, vmax=image_max, norm=LogNorm())
