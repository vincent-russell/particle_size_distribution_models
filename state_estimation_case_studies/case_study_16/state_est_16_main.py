...
Title: Computes estimates of the particle size distribution, condensation rate, deposition rate, and nucleation rate using log-scaled GDE on CSTAR observations
...
from state_space_identification_models.CSTAR_observation_models.cond_depo_sorc_estimation_log_CSTAR_linearised_parameters import *
...
if __name__ == '__main__':
    ...
    #######################################################
    # Extracting data from CSTAR20200214 experiment:
    d_obs, Y, time_CSTAR = get_CSTAR_data()  # Extracting observations
    ...
    xticks = [0.02, 0.10, 0.6]  # Plot x-tick labels
    ...
    ylimits_cond = [0, 0.03]  # Plot boundary limits for y-axis
