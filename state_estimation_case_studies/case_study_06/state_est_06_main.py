...
if __name__ == '__main__':
    ...
    # #######################################################
    # # Temporary Loading:
    # state_est_06_data_filter = np.load('state_est_06_data_filter.npz')
    # n_Dp_plot_est_filter = state_est_06_data_filter['n_Dp_plot']
    # n_Dp_plot_upper_est_filter = state_est_06_data_filter['n_Dp_plot_upper']
    # n_Dp_plot_lower_est_filter = state_est_06_data_filter['n_Dp_plot_lower']
    # norm_diff_est_filter = state_est_06_data_filter['norm_diff']
    #
    #
    # #######################################################
    # # Temporary Plotting:
    ...
    #     # ax.plot(d_plot, n_Dp_plot_est_filter[:, int(plot_time / dt)] - 100, '-', color='blue', linewidth=2, label='Mean Estimate')
    #     # ax.plot(d_plot, n_Dp_plot_upper_est_filter[:, int(plot_time / dt)], '--', color='blue', linewidth=2, label='$\pm 2 \sigma$')
    #     # ax.plot(d_plot, n_Dp_plot_lower_est_filter[:, int(plot_time / dt)], '--', color='blue', linewidth=2)
    ...
    # ax.set_title('Size distribution estimate using Kalman smoother \n at $t = 48$ hours', fontsize=14)
    # ax.legend(fontsize=12, loc='upper left')
    # plt.tight_layout()
    # fig1.savefig('fig1_smooth')
    #
    #
    # # fig 2:
    # fig2 = plt.figure(figsize=(7, 5), dpi=200)
    # ax = fig2.add_subplot(111)
    # ax.plot(t, norm_diff_est_filter, '-', color='blue', linewidth=2, label='Using Kalman filter')
    # ax.plot(t, norm_diff, '-', color='chocolate', linewidth=2, label='Using Kalman smoother')
    # ax.set_xlim([0, T])
    # ax.set_ylim([0, 18])
    ...
    # n_Dp_plot_est_filter = n_Dp_plot_est_filter.clip(image_min, image_max)
    # im = plt.pcolor(time, d_plot, n_Dp_plot_est_filter, cmap=cmap, vmin=image_min, vmax=image_max, norm=LogNorm())
    ...
    # ax.yaxis.set_label_coords(-0.05, 1.05)
    # ax.set_title('Size distribution estimate using Kalman filter', fontsize=14)
    # ax.set_xlim([0, T])
    ...
    # ax.set_ylabel(xlabel, fontsize=14, rotation=0)
    # ax.yaxis.set_label_coords(-0.05, 1.05)
    # ax.set_title('Size distribution estimate using Kalman smoother', fontsize=14)
    # ax.set_xlim([0, T])
    # ax.set_ylim([Dp_min, Dp_max])
    # ax.set_yscale('linear')
    # ax.tick_params(axis='both', which='major', labelsize=12)
