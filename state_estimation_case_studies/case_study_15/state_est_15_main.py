...
Title: Computes estimates of the particle size distribution, condensation rate, deposition rate, and nucleation rate using log-scaled GDE (comparing to CSTAR)
...
if __name__ == '__main__':
    ...
    observation_data = load_observations('simulated_observations_log_case_02')  # Loading data file
