...
if __name__ == '__main__':
    ...
    legend = ['Simulated observations', 'CSTAR observations']  # Adding legend to plot
    ...
    basic_tools.plot_1D_animation(d_obs, Y, plot_add=(d_CSTAR, Y_CSTAR), xticks=xticks, xlimits=xlimits, ylimits=ylimits, xscale=xscale, xlabel=xlabel, ylabel=ylabel, title=title,
