...
data_filename = 'observations_06_no_initial'  # Filename for data of simulated observations
...
N_0 = 0*2e3  # Amplitude of initial condition gaussian
...
I_cst_guess = 0.001  # Condensation parameter constant
I_linear_guess = 0.08  # Condensation parameter linear
...
d_linear_guess = 0.05  # Deposition parameter linear
d_inverse_quadratic_guess = 0.000002  # Deposition parameter inverse quadratic
