...
v_0 = diameter_to_volume(3)  # Mean of initial condition gaussian
v_1 = diameter_to_volume(6)  # Mean of initial condition gaussian
...
d_0_guess = 0.1  # Deposition parameter constant
