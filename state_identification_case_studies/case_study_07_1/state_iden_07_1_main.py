...
from state_identification_case_studies.case_study_07_1.state_iden_07_1_parameters import *
...
if __name__ == '__main__':
    ...
    if use_BAE:
        title_depo = 'Deposition rate estimation using BAE'  # Title for 1D animation plot
    else:
        title_depo = 'Deposition rate estimation'  # Title for 1D animation plot
