...
Title: Computes estimates of the particle size distribution, condensation rate, deposition rate, and nucleation rate using log-scaled GDE
...
from evolution_models.tools import GDE_evolution_model, change_basis_x_to_logDp_sorc, GDE_Jacobian, compute_U
...
if __name__ == '__main__':
    ...
    observation_data = load_observations('simulated_observations_log_case_01')  # Loading data file
    ...
    delay_cond = 0  # Delay between frames in milliseconds
    ...
    basic_tools.plot_1D_animation(d_plot_cond, cond_Dp_plot, cond_Dp_plot_lower, cond_Dp_plot_upper, cond_Dp_true_plot, xticks=xticks, xscale=xscale, xlabel=xlabel_cond, ylabel=ylabel_cond, title=title_cond,
