"""
Parameters for condensation, deposition, and nucleation rate estimation in log-size example
"""
...
I_cst_guess = 0.004  # Condensation parameter constant
...
gamma_p = 3
gamma_A1 = 0.1 * eye(N_gamma)
gamma_A2 = 0.2 * eye(N_gamma)
gamma_A3 = 0.7 * eye(N_gamma)
